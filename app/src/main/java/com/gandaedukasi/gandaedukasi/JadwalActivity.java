...
import com.gandaedukasi.gandaedukasi.adapter.JadwalAdapter;
import com.gandaedukasi.gandaedukasi.models.Jadwal;
...
public class JadwalActivity extends AppCompatActivity {
    ...
    private void getData(){
        if(isNetworkAvailable()){
            ...
            data = new JsonArray();
            String url = new RequestServer().getServer_url() + "getJadwalLesSiswa";
                                    ...
                                    new AlertDialog.Builder(JadwalActivity.this)
                                            ...
                                            .setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
                                                ...
                                                public void onClick(DialogInterface dialog, int which) {
                                                    Intent i = new Intent(JadwalActivity.this, MenuActivity.class);
                                                    finish();
                                                }
                                            })
                                            .show();
