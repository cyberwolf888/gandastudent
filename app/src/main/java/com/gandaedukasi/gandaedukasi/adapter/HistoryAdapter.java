...
import com.gandaedukasi.gandaedukasi.DetailPertemuanActivity;
import com.gandaedukasi.gandaedukasi.R;
import com.gandaedukasi.gandaedukasi.models.History;
...
public class HistoryAdapter extends RecyclerView.Adapter<HistoryAdapter.HistoryViewHolder> {
        ...
        public HistoryViewHolder(View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent i = new Intent(mContext, DetailPertemuanActivity.class);
    ...
    public void onBindViewHolder(HistoryViewHolder historyViewHolder, int i) {
        ...
        if(listItems.get(i).photo.equals("")){
            ...
            Ion.with(mContext)
                    .load(new RequestServer().getPhotoUrl()+"pengajar/"+listItems.get(i).photo)
                    .withBitmap()
