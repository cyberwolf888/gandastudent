...
public class CariPengajarAdapter extends RecyclerView.Adapter<CariPengajarAdapter.CariPengajarViewHolder> {
    ...
    public class CariPengajarViewHolder extends RecyclerView.ViewHolder {
        ...
        public CariPengajarViewHolder(View itemView) {
            ...
            waktu_mulai = (TextView) itemView.findViewById(R.id.tvWaktuMulai);
            waktu_selesai = (TextView) itemView.findViewById(R.id.tvWaktuSelesai);
    ...
    public void onBindViewHolder(CariPengajarViewHolder cariPengajarViewHolder, int i) {
        ...
        cariPengajarViewHolder.hari.setText(items.get(i).label_hari);
        cariPengajarViewHolder.waktu_mulai.setText(items.get(i).waktu_mulai);
        cariPengajarViewHolder.waktu_selesai.setText(items.get(i).waktu_selesai);
